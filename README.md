...
This example uses the latest [1.0.0-alpha05 version](https://developer.android.com/jetpack/androidx/releases/webgpu#webgpu-1.0.0-alpha05). It renders a simple cube, a camera can be rotated around using touch gesture. It also demostrates how to work with:
